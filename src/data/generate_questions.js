...
const catalog = [
  {
    ...
    facts: [
      ...
      { term: 'var', answer: 'are scope funcțional și este hoisted', distractors: ['are scope de bloc', 'nu poate fi declartată niciodată', 'este disponibilă doar în Node.js'] },
      { term: 'hoisting', answer: 'mută declarările funcțiilor și variabilelor în faza de compilare', distractors: ['rulează codul înainte de execuție', 'închide toate variabilele', 'fortează async/await'] },
      ...
      { term: 'event loop', answer: 'gestionază execuția task-urilor și callback-urilor în JavaScript', distractors: ['rulează tot codul în paralel', 'împachetează CSS-ul', 'înlocuiește browser-ul'] },
      ...
      { term: 'reduce()', answer: 'agreghează valorile unui array într-o singură valoare', distractors: ['clonează array-ul', 'filtrează în funcție de paritate', 'întoarce doar indexurile'] },
      ...
      { term: 'this', answer: 'se leagă de contextul de execuție al funcției', distractors: ['este mereu nodul HTML', 'este constant în toate contexte', 'nu există în strict mode'] },
      ...
      { term: 'destructuring', answer: 'extragă rapid valori din array-uri sau obiecte', distractors: ['împachetează codul CSS', 'anulează toate variabilele', 'creează în mod automat fetch-ul'] },
      ...
      { term: 'IIFE', answer: 'rulează o funcție imediat după declarare, fără a polua scope-ul global', distractors: ['este un tip de shadow DOM', 'crește dimensiunea CSS-ului', 'este folosit pentru backend exclusiv'] },
      { term: 'class', answer: 'definește un șablon pentru obiecte cu proprietăți și metode', distractors: ['este doar pentru stilizare', 'nu poate fi instanțiat', 'sunt folosite doar în HTML'] },
      { term: 'for...of', answer: 'itèrează peste valorile iterabile, precum array-uri și string-uri', distractors: ['itèrează doar prin chei', 'rulează doar în CSS', 'nu este disponibil în Node.js'] },
      { term: 'for...in', answer: 'itèrează peste cheile enumerable ale unui obiect', distractors: ['itèrează peste valorile din array', 'nu poate fi folosit pentru obiecte', 'transformă obiectele în string'] },
      ...
      { term: 'localStorage', answer: 'salvează date în browser pe durata sesiuni de navigare', distractors: ['salvează doar date secrete pe server', 'nu poate fi citit', 'este un tip de font'] },
  ...
  },
  {
    category: 'CSS',
    facts: [
      { term: 'flexbox', answer: 'alignează și distribuie elementele într-un container pe axe orizontală și verticală', distractors: ['este folosit doar pentru imagini', 'creează animații', 'nu poate poziționa elemente'] },
      { term: 'grid', answer: 'permit structurarea layout-ului în linii și coloane', distractors: ['suplantează complet HTML-ul', 'gestionează doar culorile', 'nu funcționează în browser'] },
      { term: 'position: sticky', answer: 'păstrează un element fix relativ la containerul părinte', distractors: ['fă un element invizibil', 'crește automat el', 'nu poate fi folosit cu scroll'] },
      ...
      { term: 'custom properties', answer: 'permit stocarea valorilor reutilizabile în variabile CSS', distractors: ['sunt folosite doar în JavaScript', 'nu pot fi modificate', 'sunt echivalent cu HTML'] },
      { term: 'transition', answer: 'animați trecerea unei proprietăți între două stări', distractors: ['face ca toate elementele să fie invizibile', 'funcționează doar în Node.js', 'nu suportă proprietăți'] },
      ...
      { term: 'minmax()', answer: 'setează intervale flexibile pentru dimensiunile din grid', distractors: ['dezactivează gap-ul', 'creează doar linii imaginate', 'are rol în JavaScript'] },
      ...
      { term: 'z-index', answer: 'stabilește ordinea de suprapunere a elementelor', distractors: ['controlează doar culori', 'trece automat în loop infinit', 'nu are efect'] },
      ...
      { term: 'calc()', answer: 'permite calculul valorilor CSS din expresii matematice', distractors: ['înlocuiește toate variabilele', 'nu funcționează decât în JavaScript', 'sunt doar pentru imagini'] },
      ...
      { term: 'conic-gradient()', answer: 'creează un degradat circular sau radial în funcție de unghi', distractors: ['sunt folosite numai pentru animație', 'videază containerul', 'nu suportă culori'] },
      ...
      { term: 'contain', answer: 'limitează efectele layout-ului și stilizării doar în interiorul elementului', distractors: ['transformă codul în JavaScript', 'nu poate fi folosit cu div-uri', 'dezbloacă complet layout-ul'] },
      ...
      { term: '@keyframes', answer: 'definește etapele unei animații CSS', distractors: ['setați doar culorile', 'împiedică browserul să renderizeze', 'sunt folosite doar în JavaScript'] },
      ...
      { term: 'scroll-behavior', answer: 'controlează animarea de derulare între ancoraje și scroll', distractors: ['oprește total scroll-ul', 'face toate imagini fixe', 'este un atribut JavaScript'] },
    ]
  },
  {
    category: 'React',
    facts: [
      { term: 'useState', answer: 'gestionază starea locală a unui component', distractors: ['crează automat route-uri', 'salvează date în baza de date', 'este doar pentru server'] },
      ...
      { term: 'useMemo', answer: 'memoizează o valoare costisitoare pentru a evita recalcularea inutilă', distractors: ['creează constante globale', 'empachetează HTML-ul', 'nu are niciun efect pe render'] },
      ...
      { term: 'key prop', answer: 'ajută React să identifice elementele dintr-o listă și să le re-renderizeze corect', distractors: ['este folosit pentru stilizare', 'face lista să se rupă', 'este un atribut CSS'] },
      ...
      { term: 'state', answer: 'stochează date locale care pot declanșa re-render-ul componentului', distractors: ['se salvează doar în DB', 'nu poate fi schimbat', 'sunt equivalenți cu CSS variables'] },
      { term: 'lifting state up', answer: 'mută starea într-un component părinte pentru a fi partajată', distractors: ['șterge starea locală', 'mărește automat viteza', 'nu este recomandat'] },
      ...
      { term: 'Suspense', answer: 'gestionază încărcarea asincronă a componentelor și fallback-urile', distractors: ['nu poate încărca date', 'este un tip de router', 'împiedică orice fetch'] },
      { term: 'React.lazy()', answer: 'încărcă o componentă doar la momentul în care este necesară', distractors: ['încărcă totul deodată', 'este doar pentru CSS', 'nu funcționează în React'] },
      ...
      { term: 'Portal', answer: 'rendează un element într-un container diferit din arborele DOM al aplicației', distractors: ['este un engine de backend', 'nereu se folosește', 'nu are legătură cu UI'] },
      ...
      { term: 'useReducer', answer: 'gestionează stări complexe folosind un reducer', distractors: ['este echivalent cu fetch', 'nu poate fi folosit pe obiecte', 'este doar pentru form-uri'] },
      { term: 'Rules of Hooks', answer: 'stabilește că hook-urile trebuie apelate în același mod și la nivelul corect', distractors: ['sunt reguli CSS', 'definește HTML-ul', 'oprește orice componentă'] },
      ...
      { term: 'immutability', answer: 'înseamnă că datele nu sunt mutate direct, ci create nou', distractors: ['este un tip de fetch', 'oprește toate stările', 'este doar o regulă CSS'] },
      ...
      { term: 'client-side rendering', answer: 'generează interfața în browser după încărcarea aplicației', distractors: ['sunt date generate în baza de date', 'este exclusiv server-side', 'nu folosește DOM-ul'] },
      ...
      { term: 'useId', answer: 'generați identificatori stabile pentru elementele UI în React', distractors: ['generați doar culori', 'formattează șiruri CSS', 'nu poate fi folosit în componentă'] },
      { term: 'useTransition', answer: 'permite marcarea unor update-uri ca fiind non-urgent pentru UI', distractors: ['împiedică orice render', 'este o metodă CSS', 'nu poate fi folosită în frontend'] },
      { term: 'startTransition', answer: 'marchează o actualizare ca fiind de prioritizare mai scăzută pentru UI', distractors: ['stopează re-render-ul', 'este doar pentru server', 'nu are legătură cu React'] },
    ]
  },
  {
    category: 'MongoDB',
    facts: [
      ...
      { term: '$lookup', answer: 'realizează un join între colecții', distractors: ['copiază colecția în memorie', 'împărțește datele în două baze', 'este o comandă SQL'] },
      { term: '$project', answer: 'selectează și transformă câmpurile din documentele rezultate', distractors: ['șterge toate documentele', 'creează indexuri', 'nu pot fi folosite în agregare'] },
      ...
      { term: 'sharding', answer: 'împarte datele pe mai multe servere pentru scalabilitate', distractors: ['clonază datele în memorie', 'este o tehnică CSS', 'nu are legătură cu DB'] },
      { term: 'replica set', answer: 'repliază datele pe mai multe noduri pentru redundanță și disponibilitate', distractors: ['este o structură de HTML', 'este un tip de cache', 'nu poate fi folosit pentru MongoDB'] },
      ...
      { term: 'denormalization', answer: 'duplică date pentru a reduce costurile de join și query-uri', distractors: ['creează doar noduri CSS', 'remove repeated data', 'este o tehnică de frontend'] },
      ...
      { term: 'writeConcern', answer: 'definește nivelul de confirmare pentru operațiile de scriere', distractors: ['setează comenzi SQL', 'suplinește schema CSS', 'nu se aplică datelor'] },
      { term: 'readConcern', answer: 'controlează nivelul de consistență citirii datelor', distractors: ['înlocuiește indexul', 'reglează proiectarea CSS', 'este doar pentru cache'] },
      ...
      { term: 'transactions', answer: 'asigură atomicitatea mai multor operații de scriere', distractors: ['elimintă toate datele', 'sunt disponibile doar în CSS', 'nu sunt suportate în MongoDB'] },
      { term: 'GridFS', answer: 'stochează fișiere mari împărțite în documente MongoDB', distractors: ['împachetează CSS', 'verifică viteza HTTP', 'nu are legătură cu date'] },
      ...
      { term: 'compound index', answer: 'creează un index peste mai multe câmpuri pentru query-uri complexe', distractors: ['este un tip de thread JavaScript', 'este un şablon CSS', 'este folosit doar pentru text'] },
      ...
      { term: 'change streams', answer: 'permite monitorizarea în timp real a evenimentelor din colecții', distractors: ['sunt activate doar în CSS', 'nu există în MongoDB', 'se folosește pentru serverless'] },
      { term: 'read preference', answer: 'stabilește unde se citește datele, de la primar sau secundar', distractors: ['controlează culorile din UI', 'schimbă datele de tip text', 'nu există în MongoDB'] },
    ]
  },
  {
    category: 'PostgreSQL',
    facts: [
      ...
      { term: 'UNIQUE', answer: 'impune valori distincte în cadrul unei coloane sau a unei combinații', distractors: ['permite duplicate', 'aplică doar la text', 'nu poate fi folosit pe SQL'] },
      ...
      { term: 'VACUUM', answer: 'curăță spațiul nefolosit și menține performanța bazei de date', distractors: ['sterge toate tabelele', 'împiedică toate query-urile', 'este un tip de cache al browserului'] },
      ...
      { term: 'transaction', answer: 'grupează mai multe operații astfel încât să fie fie toate aplicate, fie toate anulate', distractors: ['întrerupe script-ul', 'este un tip de CSS', 'nu are legătură cu datele'] },
      ...
      { term: 'BRIN index', answer: 'este eficient pentru tabele mari în care datele sunt ordonate logic', distractors: ['nu poate fi folosit în PostgreSQL', 'este doar pentru cache', 'sunt folosite exclusiv pentru node'] },
      ...
      { term: 'UPSERT', answer: 'înlocuiește sau inserează un rând în funcție de existența lui', distractors: ['sterge în permanență datele', 'este un tip de query CSS', 'nu există în SQL'] },
      { term: 'ALTER TABLE', answer: 'modifică structura unui tabel existent', distractors: ['creează noul browser', 'strecoară CSS-ul', 'nu poate modifica semnătura tabelului'] },
      ...
      { term: 'materialized view', answer: 'stochează rezultatul unei query pre-calculată pentru revizii rapide', distractors: ['este doar o interfață frontend', 'nu poate fi folosită în SQL', 'este un tip de browser'] },
  ...
  },
  {
    ...
    facts: [
      ...
      { term: 'stream', answer: 'permit procesarea datelor în flux, fără a încărca totul în memorie', distractors: ['oferă doar imagini statice', 'este un tip de middleware CSS', 'nu are utilitate'] },
      ...
      { term: 'child_process', answer: 'permite executarea de comenzi externe din aplicația Node.js', distractors: ['este un modul de CSS', 'nu poate shell-ui', 'nu funcționează în server'] },
      { term: 'require()', answer: 'încarcă un modul sau fișier din aplicație', distractors: ['angajează doar CSS-ul', 'elimină toate variabilele', 'este doar pentru browser'] },
      { term: 'module.exports', answer: 'expune API-ul unui modul pentru a fi utilizat în alte fișiere', distractors: ['este un element HTML', 'doar pentru CSS', 'nu există în Node.js'] },
      ...
      { term: 'fs', answer: 'modulul pentru accesarea fișierelor de sistem', distractors: ['este pentru styling', 'nu poate citi fișiere', 'este doar pentru browser'] },
      { term: 'path', answer: 'ajută la manipularea și construire de căi de fișiere', distractors: ['este un tip de CSS', 'este doar pentru URL-uri', 'nu există în Node.js'] },
      ...
      { term: 'http', answer: 'modul pentru crearea serverelor HTTP', distractors: ['este un modul CSS', 'este doar pentru frontend', 'nu poate asculta porturi'] },
      { term: 'https', answer: 'modul pentru servere HTTP securizate cu TLS', distractors: ['este doar pentru browser', 'nu există în Node.js', 'este un tip de animatie'] },
      ...
      { term: 'setImmediate()', answer: 'programa un callback după finalizarea evenimentelor curente', distractors: ['rulează înainte de orice cod', 'este doar pentru browser', 'nu poate fi folosit în Node.js'] },
      { term: 'process.nextTick()', answer: 'planifică o operațiune la următorul tick al event loop-ului', distractors: ['este un modul CSS', 'este un tip de query', 'nu există atât de performat'] },
      ...
      { term: 'zlib', answer: 'permite compresia și decomprimarea datelor', distractors: ['este un tip de layout', 'nu poate comprima fișiere', 'înlocuiește toate backend-urile'] },
      { term: 'perf_hooks', answer: 'oferă instrumente de măsurare a performanței aplicației', distractors: ['nu exist în Node.js', 'este pentru frontend doar', 'rezolvă doar probleme CSS'] },
      { term: 'dotenv', answer: 'încărcă variabilele de mediu dintr-un fișier .env', distractors: ['setează tipurile CSS', 'nu are lucru cu mediul', 'se folosește doar în browser'] },
  ...
  },
  {
    ...
    facts: [
      ...
      { term: 'query parameters', answer: 'sunt informațiile din URL după ? precum ?page=2', distractors: ['sunt doar în formularul HTML', 'nu călătoresc în URL', 'sunt variabile de style'] },
      ...
      { term: 'cors', answer: 'permite cererile din alte origini în aplicațiile web', distractors: ['închide toate cererile', 'este doar frontend', 'nu are legătură cu rețea'] },
      { term: 'express.Router()', answer: 'creează un router modular pentru a organiza rutele aplicației', distractors: ['nu există în Express', 'activați CSS în browser', 'este un obiect DOM'] },
      ...
      { term: 'REST API', answer: 'expune resurse prin URL-uri și verburi HTTP standardizate', distractors: ['este un tip de model CSS', 'nu are legătură cu serverul', 'este doar frontend'] },
      { term: 'JWT', answer: 'permite autentificarea prin token-uri semnate digital', distractors: ['este un tip de CSS', 'nu poate fi folosită în backend', 'nu există în Express'] },
    ]
  },
  {
    category: 'Tailwind',
    facts: [
      ...
      { term: '@tailwind base', answer: 'importează stilurile de bază ale framework-ului Tailwind', distractors: ['activează doar React', 'nu există în Tailwind', 'este un modul Node.js'] },
      ...
      { term: 'text-sm', answer: 'setează dimensiunea textului la un nivel specific', distractors: ['setează margini doar', 'nu există în Tailwind', 'este un atribut JavaScript'] },
      ...
      { term: 'grid', answer: 'activează layout-ul de tip grilă CSS', distractors: ['este un concept JavaScript', 'nu funcționează în browser', 'devine un modul Node.js'] },
      { term: 'justify-center', answer: 'centrează elementele pe axa principală într-un flex sau grid', distractors: ['centrulizează doar textul', 'nu există în Tailwind', 'oprește layout-ul'] },
      ...
      { term: 'arbitrary value', answer: 'permite valori personalizate după sintaxa square bracket', distractors: ['este doar variabile JavaScript', 'nu există în CSS', 'nu pot primi valori'] },
      { term: 'ring', answer: 'adaugă un contur circular sau eliptic în jurul unui element', distractors: ['mărește doar dimensiunea textului', 'nu există în Tailwind', 'este un obiect React'] },
      { term: 'ring-offset', answer: 'controlează distanța dintre ring și elementul din spate', distractors: ['modifică doar culoarea fontului', 'este un API JavaScript', 'nu poate fi folosită'] },
      { term: 'backdrop-blur', answer: 'aplică efect de blur în spatele unui element transparent', distractors: ['este doar pentru imagini', 'oprește render-ul CSS', 'nu există în Tailwind'] },
      ...
      { term: 'cursor-pointer', answer: 'schimbă cursorul într-un pointer de click', distractors: ['schimbă doar textul', 'nu există în framework', 'este obiect de formă'] },
      { term: 'truncate', answer: 'restrânge textul pe o singură linie și adaugă elipsis', distractors: ['elimină toate texturile', 'este un atribut React', 'nu poate fi folosit'] },
...
const templates = [
  ...
  ({ category, fact }) => `Cum se comportă ${fact.term} în ${category}?`,
  ({ category, fact }) => `Ce înseamnă ${fact.term} atunci când lucrezi cu ${category}?`,
  ({ category, fact }) => `Care variantă descrie corect ${fact.term} din ${category}?`,
  ({ category, fact }) => `Ce ar trebui să știi despre ${fact.term} în ${category}?`,
  ({ category, fact }) => `Care dintre afirmații descrie cel mai bine ${fact.term} din ${category}?`,
  ({ category, fact }) => `Ce este adevărat despre ${fact.term} în proiectele ${category}?`,
  ({ category, fact }) => `Care este explicația corectă pentru ${fact.term} în ${category}?`,
  ({ category, fact }) => `Ce rol are ${fact.term} în dezvoltarea ${category}?`,
  ({ category, fact }) => `Care afirmație se potrivește cel mai bine cu ${fact.term} din ${category}?`,
  ({ category, fact }) => `Ce înseamnă practic ${fact.term} în contextul ${category}?`,
  ({ category, fact }) => `Care este utilitatea principală a ${fact.term} în ${category}?`,
  ({ category, fact }) => `Cum este folosit ${fact.term} în ${category}?`,
  ({ category, fact }) => `Ce este adevărat pentru ${fact.term} în ${category}?`,
  ({ category, fact }) => `Care explicație este corectă pentru conceptul ${fact.term} din ${category}?`,
  ({ category, fact }) => `Ce este specific pentru ${fact.term} în ${category}?`,
  ({ category, fact }) => `Când vine vorba de ${fact.term}, ce este corect în ${category}?`,
  ({ category, fact }) => `Care răspuns descrie cel mai bine ${fact.term} din ${category}?`,
  ({ category, fact }) => `Care dintre variante descrie corect comportamentul ${fact.term} în ${category}?`,
  ({ category, fact }) => `Ce trebuie să știm despre ${fact.term} când lucrăm în ${category}?`,
  ({ category, fact }) => `Care este principiul de bază din spatele lui ${fact.term} în ${category}?`,
]

function buildQuestion(category, fact, difficulty, text) {
  const correctAnswer = fact.answer
  const wrongAnswers = shuffle(
    fact.distractors.filter((item) => item !== correctAnswer)
  ).slice(0, 3)
...
for (const entry of catalog) {
  for (const fact of entry.facts) {
    const orderedTemplates = shuffle([...templates])

    for (const template of orderedTemplates) {
      const difficulty = difficulties[(generated.length + entry.facts.indexOf(fact)) % difficulties.length]
      const text = template({ category: entry.category, fact })

      if (!seenTexts.has(text)) {
        seenTexts.add(text)
        generated.push(buildQuestion(entry.category, fact, difficulty, text))
      }
...
while (generated.length < targetCount) {
  for (const entry of catalog) {
    for (const fact of entry.facts) {
      const text = `Ce este important de știut despre ${fact.term} în ${entry.category} și de ce contează în practică?`
      if (!seenTexts.has(text)) {
        seenTexts.add(text)
        const difficulty = difficulties[(generated.length + entry.facts.indexOf(fact)) % difficulties.length]
        generated.push(buildQuestion(entry.category, fact, difficulty, text))
...
console.log(`Generated ${generated.length} technical questions across JavaScript, CSS, React, MongoDB, PostgreSQL, Node.js, Express and Tailwind.`)
console.log(`Unique texts: ${seenTexts.size}`)
